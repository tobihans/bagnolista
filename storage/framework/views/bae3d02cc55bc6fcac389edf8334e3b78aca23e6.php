...
<?php $component->withAttributes([]); ?>
    <?php $__env->startPush('scripts'); ?>
        <script src="<?php echo e(asset('js/cars_form.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4 mw-full">
                <form x-data="form" x-ref="form" action="<?php echo e(route('cars.store')); ?>" method="POST"
                    ...
                    <div class="text-indigo-600 font-semibold text-xl mx-2 mb-4 uppercase">
                        ...
                        <hr class="my-2">
                        <p class="mt-4 mb-2 text-sm font-sans text-gray-700 normal-case"> Les champs marqués <span class="text-red-600">*</span> sont requis.</p>
                    </div>
                    <div class="flex justify-between">
                        <div class="flex flex-col w-6/12 m-2">
                            <label for="brand" class="text-indigo-700">Marque<sup class="text-red-600">*</sup></label>
                        ...
                        <div class="flex flex-col w-6/12 m-2">
                            <label for="category" class="text-indigo-700">Categorie<sup class="text-red-600">*</sup></label>
                    ...
                    <div class="flex justify-between">
                        <div class="flex flex-col sm:flex grow m-2">
                            <label for="model" class="text-indigo-700">Modèle<sup class="text-red-600">*</sup></label>
                            <input type="text" id="model" name="model" class="mt-4 rounded" required>
                        </div>
                        <div class="flex flex-col grow m-2">
                            <label for="pricing" class="text-indigo-700">Prix de la location<sup class="text-red-600">*</sup></label>
                            <input type="number" id="pricing" name="pricing" class="mt-4 rounded" required>
                        </div>
                    </div>
                    <div class="flex justify-between">
                        <div class="flex flex-col basis-6/12 m-2">
                            <label for="brand" class="text-indigo-700">Photos<sup class="text-red-600">*</sup></label>
                    ...
                    <div x-ref="pairsBlock">
                        <div class="text-indigo-700  m-2">Spécifications<span class="text-sm">(Chaque caractéristique suivie de sa valeur)</span> </div>
                        <div class="flex justify-between" x-ref="keyValBlock">
                            <label class="flex flex-col grow m-2">
                                <span class="text-indigo-700 text-sm font-semibold">Clé<sup class="text-red-600">*</sup></span>
                                <input type="text" id="desc_keys" name="desc_keys[]" placeholder="E.g Moteur"
                                       class="mt-4 rounded" required>
                            </label>
                            <label class="flex flex-col grow m-2">
                                <span class="text-indigo-700 text-sm font-semibold">Valeur<sup class="text-red-600">*</sup></span>
...
<?php endif; ?>
<?php /**PATH /home/tobi/Code/php/bagnolista/resources/views/cars/create.blade.php ENDPATH**/ ?>